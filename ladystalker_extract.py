...
def build_glyph_table() -> dict[int, str]:
    ...
    rows = {
        ...
        # These low-resolution lookalikes were verified against their compounds
        # and the rendered 16x15 ROM font (for example 学者, 溶岩, and 後継者).
        0x08A: "島物城行入説見人伝何金宝古来書気魔生北石化代話中売館博場聞者買世査審大情報一旅動水屋活悪目学下方冒険千真側明娘写装前備天賞道発町年武巨名多謎歩連子持心地死墓嬢様部考神実芸内音券自間食研史究財鏡歴国銀奥命秘体外遠験以受作不先続誰取感客解立引料紀界昔高出力付商才鉱山戦声思火預用囚交枚換噴読溶録記掘炉会寄日泊教使具基申玉上店器品主呪通所十意敵印封返官毒強息本兵士帰度乗休白残管早全護板父観光民能侵長深今防文字塔王空法岩像建正知進役階図家海由時理然口風回術待分剣AB",
        0x175: "殿領手変利難覚花樹逆倍黒愛宿経探熱効維巻二最復過去単仕男絵勝謝位掛異新流値匠船題耳色置",
        0x1A4: "果継後岬埋好奇向集宮司",
        0x1B0: "村産沿員土急迷台遺頭身脳冬眠悲惨",
    }
